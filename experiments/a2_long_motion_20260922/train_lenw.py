...
ARM = 'L-TRAIN3106-LENW'
REPORT = ROOT / 'reports/a2_lenw_20260922'
RUNS = ROOT / 'work_dirs/a2_lenw_20260922'

base.SPECS[ARM] = dict(base.SPECS['L-TRAIN3106'])
...
def main():
    ...
    d['length_auxiliary'] = {
        ...
        'control': 'L-TRAIN3106-s1, identical except the weights are uniform',
        'parameters_added': 0,
    }
