...
ROOT=Path('/app/code')
sys.path.insert(0,str(ROOT/'experiments/a2_capacity_dynamics_20260922'))
from capacity_model import load_export
...
results=[]
for arm in ('C-CTRL','C-R101','C-DECSPLIT','C-AGENT'):
...
out={'status':'passed','scope':'entire B1 student forward including baseline AND additional detail branch; file/preprocessing/transfer excluded',
    ...
    'agent_cost':'Agent auxiliary head is removed in student export; native branch remains in every model.',
