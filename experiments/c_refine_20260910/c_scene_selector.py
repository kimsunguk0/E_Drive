...
FEATURE_VERSION = "candidate_relative_32_v1_zero_status"
TOKEN_VERSION = "public_final_traj_mlp_input_256_v1"
SELECTOR_VERSION = "candidate_scene_residual_real_zero_v1"
...
def build_features32(output, goal_xy=None):
...
class SceneResidualSelector(nn.Module):
    ...
    def forward(self, output, goal_xy=None):
        ...
        features32 = build_features32(output, goal_xy)
        with torch.autocast(device_type=xy.device.type, enabled=False):
