...
pairs = [
    ('M-NATIVE (motion 입력 원본해상도 1152)', last(R / 'a2_native_detail_20260921/M-NATIVE-s1'), last(R / 'a2_native_detail_20260921/M-LOW-s1')),
    ('S-NATIVE (scene 입력 원본해상도 1152)', last(R / 'a2_native_detail_20260921/S-NATIVE-s1'), last(R / 'a2_native_detail_20260921/S-LOW-s1')),
]
