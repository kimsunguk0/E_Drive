...
def inspect_checkpoint(path, *, worktree=None, bank=None, public_checkpoint=None, base=None,
    ...
    # Longer-trained bases are the point of this fork; the pin to the
    # 2,000-step primaries is relaxed to any full (non-limited) run.
...
def check_gpu(requested):
    require(requested in tuple(range(8)),'GPU must be explicitly assigned 0-7')
