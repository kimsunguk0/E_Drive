...
class FrozenBankDriver:
    ...
    def from_training_checkpoint(cls, checkpoint, *, expected_sha256, bank_path,
                                 ...
                                 relative_cache_manifest_path=None):
        ...
        if relative_head_path is not None:
            ...
            head,cache,receipt=load_relative_artifact(relative_head_path,
                ...
                base_checkpoint_sha256=observed,bank_sha256=bank_sha,base_goal_mode=goal_mode)
            ...
            _require(relative_head_sha256 is None and relative_cache_manifest_path is None,
