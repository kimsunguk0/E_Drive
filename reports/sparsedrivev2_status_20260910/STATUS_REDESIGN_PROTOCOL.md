...
TRAIN203/TUNE37 split remain immutable; reserve136 rows are not used here.
Post-execution clarification: historical confirmation12 consists of 32 scenes
inside original TRAIN203 and was therefore included in this training. It is not
an independent confirmation set for these new checkpoints. Earlier wording
that broadly said "reserve/held" was inaccurate; the executed split did not change.
...
The fixed terminal runs, independent B1 evaluation and raw-input verification
completed. The best B1 D3 is 0.313933, so .15 was not reached. See
FINAL_REPORT_KO.md for results and subsequent GT-only shortlist diagnostics.
The preregistered training design above was not changed during execution.
