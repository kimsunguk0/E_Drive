# Phase A ranking-loss tournament — loss_mode='pos_rank_exp'
...
model = dict(
    ...
    pts_bbox_head=dict(
        goal_decoder=dict(loss_mode='pos_rank_exp')))

total_epochs = 2
runner = dict(type='EpochBasedRunner', max_epochs=2)
work_dir = '/NHNHOME/data/sukim/adcl/work_dirs/pa_posrankexp'
