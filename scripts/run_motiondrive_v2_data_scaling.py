...
ARMS = ("scale15", "scale30", "scale45", "scale60")
ARM_SEEDS = {"scale15": 0, "scale30": 0, "scale45": 0, "scale60": 0}
HOLDOUT_ARMS = frozenset(ARMS)   # every arm trains on a subset and evaluates on the holdout
UPDATES = 6850
...
SOURCE_FILES = set(a2.SOURCE_FILES) | {
    "scripts/run_motiondrive_v2_data_scaling.py",
    }
