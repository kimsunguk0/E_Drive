#!/usr/bin/env python3
"""Durably supervise the three fixed MotionDrive P x V screen jobs."""
...
DRIVER = "scripts/run_motiondrive_v2_pv_screen.py"
...
JOB_GPU = {"direct": GPU0, "pv": GPU1, "pv_residual": GPU5}
APPROVED_GPUS = frozenset(JOB_GPU.values())
FIXED_ENV = {
