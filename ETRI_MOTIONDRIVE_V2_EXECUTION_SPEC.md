...
현재 상태(2026-09-07 20:57 KST): **P2 학습 종료: 3팔 actual rc0, C1/T0는 저장 후 SIGSEGV(-11). 원4팔 정상완주 gate 실패.**
실패를 통과 처리하지 않고 정상3팔의 분리 진단을 준비한다. 최신 사용자 허용 범위는
GPU0–5이며 실제 유휴를 확인한 GPU4·5를 다음 평가에 우선 사용한다. GPU6·7과
타 작업 중지는 허용하지 않는다. 상세 근거는 `MOTIONDRIVE_V2_P2_EXIT_INCIDENT_20260907.md` 참조.
